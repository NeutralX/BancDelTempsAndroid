...
public class Pact {
     ...
     * @param $id
     */
    public Pact(String $id, Post__ post, Integer idPact, String dateCreated, String dateFinished, String description, String title, Integer postsIdPost, Integer idAuthor, Integer idNoAuthor, Integer hours) {
        super();
        this.$id = $id;
        this.post = post;
        this.idPact = idPact;
    ...
    public Pact withPost(Post__ post) {
        this.post = post;
        return this;
    }
